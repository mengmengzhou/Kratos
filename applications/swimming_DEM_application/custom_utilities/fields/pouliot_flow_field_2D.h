#if !defined(KRATOS_POULIOT_FLOW_FIELD_2D_H)
#define KRATOS_POULIOT_FLOW_FIELD_2D_H
...
/// Assignment operator.
PouliotFlowField2D & operator=(PouliotFlowField2D const& rOther);
...
#endif // KRATOS_POULIOT_FLOW_FIELD_2D_H defined
