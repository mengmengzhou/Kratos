...
class Algorithm(BaseAlgorithm):
    ...
    def SetCustomBetaParamters(self, dictionary):
        BaseAlgorithm.SetCustomBetaParamters(self, dictionary)
    ...
    def PerformFinalOperations(self, time = None):
        ...
        file_name = self.pp.main_path + '/errors_recorded/recovery_errors.hdf5'
        ...
        os.rename(sys.stdout.path_to_console_out_file, self.post_path + '/' + sys.stdout.path_to_console_out_file)
        empty = False
        add_to_name = ''
        count = 0
