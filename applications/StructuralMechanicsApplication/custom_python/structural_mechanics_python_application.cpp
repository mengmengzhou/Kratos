...
BOOST_PYTHON_MODULE(KratosStructuralMechanicsApplication)
{
	...
	//ROCO NET
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(KB_RING)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(KT_RING)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(DIAMETER_RING)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(WIRE_THICKNESS_RING)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(WIRE_WINDINGS_RING)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(NODAL_MASS_RING)
