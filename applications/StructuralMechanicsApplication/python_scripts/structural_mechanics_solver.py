...
class MechanicalSolver(object):
    ...
    def _create_builder_and_solver(self):
        ...
        if(self.settings["multi_point_constraints_used"].GetBool() == True):
            builder_and_solver = StructuralMechanicsApplication.ResidualBasedBlockBuilderAndSolverWithMpc(linear_solver)
        elif(self.settings["block_builder"].GetBool() == True):
