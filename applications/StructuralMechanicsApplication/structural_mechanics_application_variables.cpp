...
KRATOS_CREATE_VARIABLE( bool, IS_STABILITY_EIGENPROBLEM)
...
KRATOS_CREATE_VARIABLE(Vector, ORTHOTROPIC_FIBER_ORIENTATION)
...
KRATOS_CREATE_VARIABLE(double , SECTION_ROTATION)
