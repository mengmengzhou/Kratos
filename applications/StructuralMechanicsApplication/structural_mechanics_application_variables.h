...
KRATOS_DEFINE_VARIABLE( bool, IS_STABILITY_EIGENPROBLEM)
...
KRATOS_DEFINE_VARIABLE( Vector, LOCAL_AXIS_VECTOR_1)
KRATOS_DEFINE_VARIABLE(Matrix, LOCAL_ELEMENT_ORIENTATION)
KRATOS_DEFINE_VARIABLE(double, ORTHOTROPIC_ORIENTATION_ASSIGNMENT)
KRATOS_DEFINE_VARIABLE(Vector, ORTHOTROPIC_FIBER_ORIENTATION_1)
...
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_STRESS_TOP_SURFACE)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_STRESS_TOP_SURFACE_GLOBAL)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_STRESS_MIDDLE_SURFACE)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_STRESS_MIDDLE_SURFACE_GLOBAL)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_STRESS_BOTTOM_SURFACE)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_STRESS_BOTTOM_SURFACE_GLOBAL)
KRATOS_DEFINE_VARIABLE(double, VON_MISES_STRESS_TOP_SURFACE)
KRATOS_DEFINE_VARIABLE(double, VON_MISES_STRESS_MIDDLE_SURFACE)
KRATOS_DEFINE_VARIABLE(double, VON_MISES_STRESS_BOTTOM_SURFACE)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_ORTHOTROPIC_STRESS_BOTTOM_SURFACE)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_ORTHOTROPIC_STRESS_TOP_SURFACE)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_ORTHOTROPIC_STRESS_BOTTOM_SURFACE_GLOBAL)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_ORTHOTROPIC_STRESS_TOP_SURFACE_GLOBAL)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_ORTHOTROPIC_4PLY_THROUGH_THICKNESS)
KRATOS_DEFINE_VARIABLE(double, TSAI_WU_RESERVE_FACTOR)
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_ORTHOTROPIC_LAMINA_STRENGTHS)

// Shell energies
KRATOS_DEFINE_VARIABLE(double, SHELL_ELEMENT_MEMBRANE_ENERGY)
KRATOS_DEFINE_VARIABLE(double, SHELL_ELEMENT_BENDING_ENERGY)
KRATOS_DEFINE_VARIABLE(double, SHELL_ELEMENT_SHEAR_ENERGY)
KRATOS_DEFINE_VARIABLE(double, SHELL_ELEMENT_MEMBRANE_ENERGY_FRACTION)
KRATOS_DEFINE_VARIABLE(double, SHELL_ELEMENT_BENDING_ENERGY_FRACTION)
KRATOS_DEFINE_VARIABLE(double, SHELL_ELEMENT_SHEAR_ENERGY_FRACTION)

// Cross section
KRATOS_DEFINE_VARIABLE(Matrix, SHELL_ORTHOTROPIC_LAYERS)
...
KRATOS_DEFINE_VARIABLE( double, SECTION_ROTATION)
