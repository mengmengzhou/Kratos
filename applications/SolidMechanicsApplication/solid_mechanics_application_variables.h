...
namespace Kratos
{
  ...
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(SOLID_MECHANICS_APPLICATION, ANGULAR_MIDDLE_VELOCITY)
  //KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS( SOLID_MECHANICS_APPLICATION, DELTA_DISPLACEMENT )
  KRATOS_DEFINE_APPLICATION_VARIABLE(SOLID_MECHANICS_APPLICATION, int,DOF_LIST_SIZE)
