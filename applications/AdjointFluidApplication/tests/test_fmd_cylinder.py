...
class TestCase(KratosUnittest.TestCase):
    ...
    def test_cylinder(self):
        with ControlledExecutionScope(os.path.dirname(os.path.realpath(__file__))):
            model_part_file_name = 'test_fmd_cylinder/test_fmd_cylinder'
            ...
            test = self.createTest('test_fmd_cylinder/test_fmd_cylinder_adjoint')
            test.Solve()
            ...
            _finite_difference_sensitivity = self.ComputeFiniteDifferenceSensitivity(\
                        node_ids, \
                        step_size, \
                        './test_fmd_cylinder/test_fmd_cylinder', \
                        './test_fmd_cylinder/flow_mal_distribution.data')
            ...
            self.removeFile("./test_fmd_cylinder/test_fmd_cylinder_0.h5")
            self.removeFile("./test_fmd_cylinder/flow_mal_distribution.data")
            self.removeFile("./test_fmd_cylinder/test_fmd_cylinder.time")
            self.removeFile("./test_fmd_cylinder/test_fmd_cylinder_adjoint.time")
